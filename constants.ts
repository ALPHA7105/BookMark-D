...
export const INITIAL_BOOKS: Book[] = [
  ...
  },
  {
    ...
    author: 'Neon Horizons',
    description: 'The sun begins pulsing in unnatural intervals — and the station AI insists it’s intentional.',
    theme: 'sci-fi',
    totalChapters: 5,
    readingLevel: 'Standard',
    readCount: 0,
  ...
  {
    id: 'n-2',
    title: 'The Gravity Market',
    author: 'Neon Horizons',
    description: 'In a floating city where gravity is traded like currency, someone is stealing weight itself.',
    theme: 'sci-fi',
    totalChapters: 4,
    readingLevel: 'Standard',
    readCount: 0,
  ...
  {
    id: 'n-3',
    title: 'Echoes of Titan Glass',
    author: 'Neon Horizons',
    description: 'A shattered moon begins reflecting futures instead of light.',
    theme: 'sci-fi',
    totalChapters: 6,
    readingLevel: 'Standard',
    readCount: 0,
  ...
  {
    id: 'n-4',
    title: 'The Pulse Between Stars',
    author: 'Neon Horizons',
    description: 'Every jump through hyperspace leaves behind a heartbeat… and something begins answering.',
    theme: 'sci-fi',
    totalChapters: 5,
    readingLevel: 'Standard',
    readCount: 0,
    coverImage: 'https://images.unsplash.com/photo-1454789548928-9efd52dc4031'
  },
  {
    id: 'n-5',
    title: 'Orbital Blackout',
    author: 'Neon Horizons',
    description: 'An entire satellite ring loses memory of the last 24 hours.',
    theme: 'sci-fi',
    totalChapters: 4,
    readingLevel: 'Standard',
    readCount: 0,
  ...
  {
    id: 'n-6',
    title: 'Signal From the Dark Orbit',
    author: 'Neon Horizons',
    description: 'A signal arrives from a dead colony that was never supposed to exist.',
    theme: 'sci-fi',
    totalChapters: 5,
    readingLevel: 'Standard',
    readCount: 0,
  ...
  {
    id: 'n-7',
    title: 'The Synthetic Comet',
    author: 'Neon Horizons',
    description: 'A comet appears — but it’s broadcasting code.',
    theme: 'sci-fi',
    totalChapters: 6,
    readingLevel: 'Standard',
    readCount: 0,
    coverImage: 'https://images.unsplash.com/photo-1462332420958-a05d1e002413'
  },
  {
    id: 'n-8',
    title: 'Void Traffic Control',
    author: 'Neon Horizons',
    description: 'Ships begin disappearing along mapped routes that shouldn’t exist.',
    theme: 'sci-fi',
    totalChapters: 5,
    readingLevel: 'Standard',
    readCount: 0,
  ...
  {
    id: 'n-9',
    title: 'The Light That Arrived Early',
    author: 'Neon Horizons',
    description: 'A star’s light reaches Earth before the star itself forms.',
    theme: 'sci-fi',
    totalChapters: 6,
    readingLevel: 'Standard',
    readCount: 0,
    coverImage: 'https://images.unsplash.com/photo-1447433819943-74a20887a5b3'
  },
  {
    id: 'n-10',
    title: 'Neon Horizon Prime',
    author: 'Neon Horizons',
    description: 'The edge of mapped space reveals a structure older than physics.',
    theme: 'sci-fi',
    totalChapters: 7,
    readingLevel: 'Standard',
    readCount: 0,
    coverImage: 'https://images.unsplash.com/photo-1450849608880-6f787542c88a'
  },
  {
    id: 'cr-2',
    title: 'Noir Shadows',
