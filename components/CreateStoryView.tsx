  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newBook: Book = {
      ...
      coverImage: formData.coverImage?.trim() !== '' 
        ? formData.coverImage 
        : `https://picsum.photos/seed/${formData.title || 'default'}/600/900`,
      ...
      <div className="bg-[#0f172a] rounded-[4rem] p-12 md:p-20 border border-white/5 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-10 font-sans">
            ...
            <div>
              <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mb-4">Custom Description</label>
              <textarea
                placeholder="Write your own story description here..."
                className="w-full bg-white/5 border border-white/10 rounded-3xl p-6 text-lg focus:border-cyan-400 outline-none transition-all resize-none h-32"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                >
                  <option value="shorts">Quick Reads</option>
            ...
            {/* NEW: Cover Image URL Input */}
            <div>
              <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mb-4">Custom Cover Image URL</label>
              <input
                type="text"
                placeholder="Paste an image URL for your cover"
                className="w-full bg-white/5 border border-white/10 rounded-3xl p-6 text-lg focus:border-purple-400 outline-none transition-all"
